...
export const assignments: IAssignment[] = [
  {
    ...
    finalSubmissionDeadline: new Date('2029-09-22'),
    status: 'closed',
    gradingStatus: 'in-progress',
    isPublished: true, 
    areGradesReleased: false,
    selfGradingEnabled: true,
    problems: [
      {
        id: 'problem1',
  ...
  },
  {
    ...
    dueDate: new Date('2024-02-20'), // Updated due date
    finalSubmissionDeadline: new Date('2024-02-27'), // Updated final submission deadline
    status: 'released',
    gradingStatus: 'not-started',    
    isPublished: true, 
    ...
    problems: [
      {
        ...
        rubric: [
          ...
          { id: 'rubric3', description: 'improper handling of all cases', points: -5 },
          { id: 'rubric4', description: 'something handling of all cases', points: -5 }
        ],
        rubricFinalized: false
      },
      {
